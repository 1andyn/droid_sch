...
public class Vis_CellTest extends TestCase {
    ...
    public void testGetheights() throws Exception {
        Vis_Cell vc = new Vis_Cell(11,12,13,0,0,0, 1);
